 ...
 * Provides a dictionary for elements which have #PCDATA
 */
...
public class PcDataElementCollector implements XMLDTDContentModelHandler {

	private XMLDTDContentModelSource modelSource;
	private String sCurrentElement;
	private boolean expectingPCData;
	private final Map<String, Boolean> elementHasPcData = new HashMap<>();
	...
	public void startContentModel(String elementName, Augmentations augmentations) throws XNIException {
		...
		elementHasPcData.put(elementName, false);
	}
	...
	public void pcdata(Augmentations augmentations) throws XNIException {
		if (expectingPCData) {
			...
			elementHasPcData.put(sCurrentElement, true);
		}
		expectingPCData = false;
	}
	...
	@Override
	public void any(Augmentations a) throws XNIException {
	}

	@Override
	public void empty(Augmentations a) throws XNIException {
	}

	@Override
	public void occurrence(short o, Augmentations a) throws XNIException {
	}
	...
	public boolean hasPcData(String elementName) {
		return Boolean.TRUE.equals(elementHasPcData.get(elementName));
	}

	public void dumpContentElements() {
		System.out.println("map:");
		System.out.print(elementHasPcData.toString());
	}
}